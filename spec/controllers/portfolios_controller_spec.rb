...
RSpec.describe PortfoliosController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new portfolio" do

        post :create, params: {portfolio: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(portfolio_url(Portfolio.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new portfolio" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the portfolio" do
        portfolio = Portfolio.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the portfolio" do
        portfolio = Portfolio.create! valid_attributes
